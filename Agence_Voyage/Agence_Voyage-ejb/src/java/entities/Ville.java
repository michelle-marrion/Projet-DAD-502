...
@NamedQueries({
    ...
    , @NamedQuery(name = "Ville.findByDescription", query = "SELECT v FROM Ville v WHERE v.description = :description")})
public class Ville implements Serializable {
    ...
    public Ville(Integer id, String nom, String description) {
        this.id = id;
        this.nom = nom;
